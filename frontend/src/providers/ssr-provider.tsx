...
/**
 * A hook that returns whether the component is currently being server side
 * @returns {boolean} Whether the component is currently being server side
 * rendered or hydrated on the client. Can be used to delay browser-specific
 * rendering until after hydration.
 * @see {@link https://ko.react.dev/reference/react/useSyncExternalStore}
 * @see {@link https://github.com/adobe/react-spectrum/blob/main/packages/%40react-aria/ssr/src/SSRProvider.tsx | source}
 */
